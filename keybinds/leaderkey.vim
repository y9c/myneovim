...
if dein#tap('coc.nvim')
  ...
  " Open coc log for debugging
  nnoremap <silent> <leader>cl  :<C-u>CocOpenLog<CR>
  " Using CocList
...
if dein#tap('vim-clap')
  nnoremap <silent> <leader>sf :Clap files<CR>
  nnoremap <silent> <leader>ss :Clap grep<CR>
  nnoremap <silent> <leader>sg :<C-u>Clap gfiles<CR>
  nnoremap <silent> <leader>sw :Clap grep ++query=<cword><CR>
  nnoremap <silent> <leader>sc :Clap command<CR>
  nnoremap <silent> <leader>sh :Clap command_history<CR>
  nnoremap <silent> <leader>sm :Clap marks<CR>
  nnoremap <silent> <leader>Tc :Clap colors<CR>
  nnoremap <silent> <leader>Ws :<C-u>Clap windows<CR>
...
if dein#tap('vim-smartchr')
    ...
    autocmd FileType go inoremap <buffer> <expr> .
            \ smartchr#loop('.', '<-', '->', '...')
    autocmd FileType r inoremap <buffer> <expr> >
            \ smartchr#loop('>', ' %>% ')
    autocmd FileType r inoremap <buffer> <expr> <
            \ smartchr#loop('<', ' <- ')
endif
